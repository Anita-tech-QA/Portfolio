...
- Related Bug Report: [BR05 – Incorrect Status Codes for Unauthorized Tokens](../Bug-Reports/BR05-GET-song-info-returns-incorrect-status-codes-for-unauthorized-tokens.md)
