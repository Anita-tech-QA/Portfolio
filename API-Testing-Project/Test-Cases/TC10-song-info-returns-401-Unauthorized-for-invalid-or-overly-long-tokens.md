...
- Related Bug Report: [BR10 – Incorrect Status Codes for Unauthorized Tokens](../Bug-Reports/BR10-song-info-returns-incorrect-status-codes-for-unauthorized-tokens.md)
