...
- Related Bug Report: [BR10 – Incorrect Status Codes for Unauthorized Tokens](Bug-Reports/TC10-song-info-returns-incorrect-status-codes-for-unauthorized-tokens.md)
